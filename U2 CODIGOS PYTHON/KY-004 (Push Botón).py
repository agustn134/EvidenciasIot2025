#Evitar que el mensaje se actualice constantemente y solo se publique cuando el sensor cambie de estado
    ...
    try:
        ...
        if current_state != last_state:
            ...
            if current_state == 0:  # Botón presionado
                message = "TextoBotonPresionado"
                print("Botón presionado")
            else:  # Botón no presionado
                message = "TextoBotonNoPresionado"
